...
// 👇 NUEVO AVATAR
import pastorAvatarImg from "../../../assets/img/pastor_kinaliani.png";
...
export const AvatarUser = () => {
    ...
    // 👇 ahora SIEMPRE usa la imagen del pastor si no hay avatar
    const avatarSrc =
        user?.profilePincture && user.profilePincture.trim() !== ""
