...
export const MesasModalDelete = ({ isOpen, onClose, onConfirm, mesa }) => {
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-In">
                <div className="p-6">
                    ...
                    <p className="text-center text-gray-600 mb-6">
                        ...
                        <span className="font-semibold text-gray-900">{mesa?.id}</span> de <span className="font-semibold text-gray-900">{mesa?.branch}</span>. <br/>
...
export default MesasModalDelete;
